...
/* harmony import */ var _model_movies_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../model/movies.js */ "./src/model/movies.js");
...
class Api {
  ...
  getMovies() {
    return this._load({
      ...
      .then(Api.toJSON)
      .then((movies) => movies.map(_model_movies_js__WEBPACK_IMPORTED_MODULE_0__["default"].adaptToClient));
  }
  ...
  getComments(film) {
    return this._load({
      ...
      .then(Api.toJSON)
      .then((comments) => comments.map(_model_movies_js__WEBPACK_IMPORTED_MODULE_0__["default"].adaptCommentsToClient));
  }
  ...
  updateFilm(film) {
    return this._load({
      url: `movies/${film.id}`,
      method: Method.PUT,
      body: JSON.stringify(_model_movies_js__WEBPACK_IMPORTED_MODULE_0__["default"].adaptToServer(film)),
      headers: new Headers({
        "Content-Type": `application/json`
      })
    })
      .then(Api.toJSON)
      .then(_model_movies_js__WEBPACK_IMPORTED_MODULE_0__["default"].adaptToClient);
  }
  ...
  addComment(film, comments) {
    ...
    return this._load({
      ...
      method: Method.POST,
      body: JSON.stringify(_model_movies_js__WEBPACK_IMPORTED_MODULE_0__["default"].adaptCommentToServer(lastComment)),
      headers: new Headers({"Content-Type": `application/json`})
    })
    .then(Api.toJSON)
    .then((comment) =>{
      comments = comment.comments;
      const adaptedComments = comments.map(_model_movies_js__WEBPACK_IMPORTED_MODULE_0__["default"].adaptCommentsToClient);
  ...
  getMovies() {
    ...
    if (Provider.isOnline()) {
      ...
      .then((comments) => {
        ...
        const items = createStoreStructure(films.map(_model_movies_js__WEBPACK_IMPORTED_MODULE_0__["default"].adaptToServer));
    ...
    return Promise.resolve(storeMovies.map(_model_movies_js__WEBPACK_IMPORTED_MODULE_0__["default"].adaptToClient));
  }
  ...
  updateFilm(film) {
    if (Provider.isOnline()) {
      ...
      .then((updatedFilm) => {
        ...
        this._store.setItem(updatedFilm.id, Object.assign({}, _model_movies_js__WEBPACK_IMPORTED_MODULE_0__["default"].adaptToServer(updatedFilm), {comments: film.comments}));
        return Promise.resolve(updatedFilm);
      });
    }

    this._store.removeItem(film.id);
    this._store.setItem(film.id, Object.assign({}, _model_movies_js__WEBPACK_IMPORTED_MODULE_0__["default"].adaptToServer(film), {comments: film.comments}));
  ...
  addComment(film, comments) {
    if (Provider.isOnline()) {
      ...
      .then((updatedComments) => {
        ...
        this._store.setItem(film.id, Object.assign({}, _model_movies_js__WEBPACK_IMPORTED_MODULE_0__["default"].adaptToServer(film), {comments: updatedComments}));
...
/*!**********************!*\
  !*** ./src/const.js ***!
  \**********************/
/*! exports provided: ESC_CODE, ENTER_CODE, SortType, emojiMap, UserAction, UpdateType, FilterType, MenuItem */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "ESC_CODE", function() { return ESC_CODE; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "ENTER_CODE", function() { return ENTER_CODE; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "SortType", function() { return SortType; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "emojiMap", function() { return emojiMap; });
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _presenter_user_profile_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./presenter/user-profile.js */ "./src/presenter/user-profile.js");
/* harmony import */ var _view_footer_statisctic_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./view/footer-statisctic.js */ "./src/view/footer-statisctic.js");
...
/* harmony import */ var _presenter_movie_list_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./presenter/movie-list.js */ "./src/presenter/movie-list.js");
/* harmony import */ var _model_movies_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./model/movies.js */ "./src/model/movies.js");
/* harmony import */ var _model_filter_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./model/filter.js */ "./src/model/filter.js");
/* harmony import */ var _presenter_filter_js__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./presenter/filter.js */ "./src/presenter/filter.js");
...
/* harmony import */ var _api_index_js__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./api/index.js */ "./src/api/index.js");
...
const moviesModel = new _model_movies_js__WEBPACK_IMPORTED_MODULE_5__["default"]();
const filtersModel = new _model_filter_js__WEBPACK_IMPORTED_MODULE_6__["default"]();
const filterPresenter = new _presenter_filter_js__WEBPACK_IMPORTED_MODULE_7__["default"](siteMainElement, filtersModel, moviesModel);
const moviePresenter = new _presenter_movie_list_js__WEBPACK_IMPORTED_MODULE_4__["default"](siteMainElement, moviesModel, filtersModel, apiWithProvider);
...
const handleSiteMenuClick = (menuItem) => {
  ...
  switch (menuItem) {
    case _const_js__WEBPACK_IMPORTED_MODULE_3__["MenuItem"].FILTER:
      currentMenuMode = menuItem;
      siteStatistic.destroy();
      moviePresenter.init();
      break;
    case _const_js__WEBPACK_IMPORTED_MODULE_3__["MenuItem"].STATISTICS:
      currentMenuMode = menuItem;
      siteStatistic = new _view_statistics_js__WEBPACK_IMPORTED_MODULE_8__["default"](moviesModel.getFilms(), siteMainElement);
...
let currentMenuMode = _const_js__WEBPACK_IMPORTED_MODULE_3__["MenuItem"].FILTER;
...
apiWithProvider.getMovies().then((films) => {
  ...
  moviesModel.setFilms(_const_js__WEBPACK_IMPORTED_MODULE_3__["UpdateType"].INIT, films);
  filterPresenter.turnOnFilters();
  filterPresenter.setMenuClickHandler(handleSiteMenuClick);
  const userProfilePresenter = new _presenter_user_profile_js__WEBPACK_IMPORTED_MODULE_0__["default"](siteHeaderElement, moviesModel);
  userProfilePresenter.init();
  Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_2__["render"])(siteFooterElement, new _view_footer_statisctic_js__WEBPACK_IMPORTED_MODULE_1__["default"](moviesModel.getFilms().length), _utils_render_js__WEBPACK_IMPORTED_MODULE_2__["RenderPosition"].BEFOREEND);
})
.catch(() => {
  moviesModel.setFilms(_const_js__WEBPACK_IMPORTED_MODULE_3__["UpdateType"].INIT, []);
});
...
class Movies extends _utils_observer_js__WEBPACK_IMPORTED_MODULE_0__["default"] {
  constructor() {
    super();
...
/* harmony import */ var _view_film_popup_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../view/film-popup.js */ "./src/view/film-popup.js");
/* harmony import */ var _utils_render_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../utils/render.js */ "./src/utils/render.js");
/* harmony import */ var _const_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../const.js */ "./src/const.js");
...
class FilmPresenter {
  ...
  init(film) {
    ...
    this._filmPopupComponent = new _view_film_popup_js__WEBPACK_IMPORTED_MODULE_1__["default"](film);
    ...
    if (prevFilmComponent === null || prevFilmPopupComponent === null) {
      Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_2__["render"])(this._filmContainer, this._filmComponent, _utils_render_js__WEBPACK_IMPORTED_MODULE_2__["RenderPosition"].BEFOREEND);
  ...
  _escKeyDownHandler(evt) {
    ...
    if (evt.key === _const_js__WEBPACK_IMPORTED_MODULE_3__["ESC_CODE"]) {
      evt.preventDefault();
  ...
  _addToWatchListClickHandler(film = this._film) {
    this._changeData(
        _const_js__WEBPACK_IMPORTED_MODULE_3__["UserAction"].UPDATE_FILM,
  ...
  _deleteClickHandler(film, targetComment) {
    return this._changeData(
        _const_js__WEBPACK_IMPORTED_MODULE_3__["UserAction"].DELETE_COMMENT,
        _const_js__WEBPACK_IMPORTED_MODULE_3__["UpdateType"].MINOR,
        film, targetComment);
  }
  ...
  _addCommentKeyDown(film) {
    return this._changeData(
        _const_js__WEBPACK_IMPORTED_MODULE_3__["UserAction"].ADD_COMMENT,
        _const_js__WEBPACK_IMPORTED_MODULE_3__["UpdateType"].MINOR,
        film);
  }
...
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return Filter; });
/* harmony import */ var _view_site_nav_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../view/site-nav.js */ "./src/view/site-nav.js");
...
class Filter {
  ...
  init() {
    ...
    this._siteNavComponent = new _view_site_nav_js__WEBPACK_IMPORTED_MODULE_0__["default"](filters, this._currentFilter, this._isDisable);

    if (prevFilterComponent === null) {
      Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_1__["render"])(this._filterContainer, this._siteNavComponent, _utils_render_js__WEBPACK_IMPORTED_MODULE_1__["RenderPosition"].BEFOREEND);
      return;
    }

    Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_1__["replace"])(this._siteNavComponent, prevFilterComponent);
  ...
  _handleFilterTypeChange(filterType) {
    ...
    this._filterModel.setFiltrationType(_const_js__WEBPACK_IMPORTED_MODULE_3__["UpdateType"].MAJOR, filterType);
  }
  ...
  _getFilters() {
    ...
    return [
      {
        type: _const_js__WEBPACK_IMPORTED_MODULE_3__["FilterType"].WATCHLIST,
        name: `Watchlist`,
        count: _utils_filter_js__WEBPACK_IMPORTED_MODULE_2__["filter"][_const_js__WEBPACK_IMPORTED_MODULE_3__["FilterType"].WATCHLIST](films).length
      },
      {
        type: _const_js__WEBPACK_IMPORTED_MODULE_3__["FilterType"].HISTORY,
        name: `History`,
        count: _utils_filter_js__WEBPACK_IMPORTED_MODULE_2__["filter"][_const_js__WEBPACK_IMPORTED_MODULE_3__["FilterType"].HISTORY](films).length
      },
      {
        type: _const_js__WEBPACK_IMPORTED_MODULE_3__["FilterType"].FAVORITES,
        name: `Favorites`,
        count: _utils_filter_js__WEBPACK_IMPORTED_MODULE_2__["filter"][_const_js__WEBPACK_IMPORTED_MODULE_3__["FilterType"].FAVORITES](films).length
      },
    ];
  }
...
/* harmony import */ var _film_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./film.js */ "./src/presenter/film.js");
/* harmony import */ var _view_site_sort_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../view/site-sort.js */ "./src/view/site-sort.js");
/* harmony import */ var _view_site_main_content_containers__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../view/site-main-content-containers */ "./src/view/site-main-content-containers.js");
/* harmony import */ var _view_site_films_list__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../view/site-films-list */ "./src/view/site-films-list.js");
/* harmony import */ var _view_films_list_title_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../view/films-list-title.js */ "./src/view/films-list-title.js");
/* harmony import */ var _view_site_film_container_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../view/site-film-container.js */ "./src/view/site-film-container.js");
/* harmony import */ var _view_loading_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../view/loading.js */ "./src/view/loading.js");
/* harmony import */ var _view_site_no_data_js__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../view/site-no-data.js */ "./src/view/site-no-data.js");
...
/* harmony import */ var _utils_films_js__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ../utils/films.js */ "./src/utils/films.js");
...
class MovieList {
  constructor(movieListContainer, moviesModel, filterModel, api) {
    ...
    this._siteNoData = new _view_site_no_data_js__WEBPACK_IMPORTED_MODULE_7__["default"]();
    this._currentSortType = _const_js__WEBPACK_IMPORTED_MODULE_12__["SortType"].DEFAULT;
    this._filmPresenter = new Map();
    this._isLoading = true;
    this._loadingComponent = new _view_loading_js__WEBPACK_IMPORTED_MODULE_6__["default"]();
  ...
  init() {
    this._filmContainer = new _view_site_main_content_containers__WEBPACK_IMPORTED_MODULE_2__["default"]();
    this._siteDefaultFilmsList = new _view_site_films_list__WEBPACK_IMPORTED_MODULE_3__["default"](DEFAULT_FILM_LIST_CLASS);

    this._siteExtraFilmsLists = new Array(QUANTITY_OF_EXTRA_FILMS_LISTS).fill().map(() => new _view_site_films_list__WEBPACK_IMPORTED_MODULE_3__["default"](EXTRA_FILMS_LIST_CLASS));

    Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_10__["render"])(this._movieListContainer, this._filmContainer, _utils_render_js__WEBPACK_IMPORTED_MODULE_10__["RenderPosition"].BEFOREEND);
    Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_10__["render"])(this._filmContainer, this._siteDefaultFilmsList, _utils_render_js__WEBPACK_IMPORTED_MODULE_10__["RenderPosition"].BEFOREEND);

    this._siteExtraFilmsLists.forEach((element) => {
      Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_10__["render"])(this._filmContainer, element, _utils_render_js__WEBPACK_IMPORTED_MODULE_10__["RenderPosition"].BEFOREEND);
    });
  ...
  destroy() {
    ...
    Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_10__["remove"])(this._filmContainer);
  ...
  _getFilms() {
    ...
    const filtredFilms = _utils_filter_js__WEBPACK_IMPORTED_MODULE_9__["filter"][filterType](films);

    switch (this._currentSortType) {
      case _const_js__WEBPACK_IMPORTED_MODULE_12__["SortType"].DATE:
        return filtredFilms.sort(_utils_films_js__WEBPACK_IMPORTED_MODULE_11__["sortFilmsByDate"]);
      case _const_js__WEBPACK_IMPORTED_MODULE_12__["SortType"].RATING:
        return filtredFilms.sort(_utils_films_js__WEBPACK_IMPORTED_MODULE_11__["sortFilmsByRating"]);
    }
  ...
  _handleViewAction(actionType, updateType, update, targetComment) {
    let film = null;
    switch (actionType) {
      case _const_js__WEBPACK_IMPORTED_MODULE_12__["UserAction"].UPDATE_FILM:
        this._api.updateFilm(update).then((movie) => {
          this._moviesModel.updateFilms(updateType, movie);
        });
        break;
      case _const_js__WEBPACK_IMPORTED_MODULE_12__["UserAction"].ADD_COMMENT:
        film = update;
        for (const presenter of this._filmPresenter.keys()) {
          if (presenter[0] === film.id) {
            this._filmPresenter.get(presenter).setViewState(_film_js__WEBPACK_IMPORTED_MODULE_0__["State"].SAVING);
          }
        }
        ...
        .catch(()=>{
          for (const presenter of this._filmPresenter.keys()) {
            if (presenter[0] === film.id) {
              this._filmPresenter.get(presenter).setViewState(_film_js__WEBPACK_IMPORTED_MODULE_0__["State"].ABORTING);
            }
          }
        });
      case _const_js__WEBPACK_IMPORTED_MODULE_12__["UserAction"].DELETE_COMMENT:
        film = update;
        for (const presenter of this._filmPresenter.keys()) {
          if (presenter[0] === film.id) {
            this._filmPresenter.get(presenter).setViewState(_film_js__WEBPACK_IMPORTED_MODULE_0__["State"].DELETING, targetComment);
          }
        }
  ...
  _handleModelEvent(updateType, updatedFilm) {
    ...
    switch (updateType) {
      case _const_js__WEBPACK_IMPORTED_MODULE_12__["UpdateType"].PATCH:
        presenters.forEach((presenter) => {
          this._filmPresenter.get(presenter).init(updatedFilm);
        }, this);
        break;
      case _const_js__WEBPACK_IMPORTED_MODULE_12__["UpdateType"].MINOR:
        this._clearMovieList({isPopupOppened: true});
        this._renderMovies();
        break;
      case _const_js__WEBPACK_IMPORTED_MODULE_12__["UpdateType"].MAJOR:
        this._clearMovieList({resetRenderedFilms: true, resetSortType: true, isPopupOppened: true});
        this._renderMovies();
        break;
      case _const_js__WEBPACK_IMPORTED_MODULE_12__["UpdateType"].INIT:
        this._isLoading = false;
        Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_10__["remove"])(this._loadingComponent);
        this._renderMovies();
        break;
    }
  }
  ...
  _renderNoData() {
    Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_10__["render"])(this._movieListContainer, this._siteNoData, _utils_render_js__WEBPACK_IMPORTED_MODULE_10__["RenderPosition"].BEFOREEND);
  }

  _renderFilmCard(filmContainer, film, i = 0) {
    const filmPresenter = new _film_js__WEBPACK_IMPORTED_MODULE_0__["default"](filmContainer, this._handleViewAction, this._handleModeChange);
    filmPresenter.init(film);
    this._filmPresenter.set([film.id, i], filmPresenter);
  }

  _renderLoading() {
    Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_10__["render"])(this._movieListContainer, this._loadingComponent, _utils_render_js__WEBPACK_IMPORTED_MODULE_10__["RenderPosition"].BEFOREEND);
  }
  ...
  _renderShowMoreButton() {
    ...
    this._showMoreButton = new _view_show_more_button_js__WEBPACK_IMPORTED_MODULE_8__["default"]();
    this._showMoreButton.setClickHandler(this._handleShowMoreButtonClick);

    Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_10__["render"])(this._siteDefaultFilmsList, this._showMoreButton, _utils_render_js__WEBPACK_IMPORTED_MODULE_10__["RenderPosition"].BEFOREEND);
  }
  ...
  _renderExtraFilmsContainers() {
    ...
    this._siteExtraFilmsLists.forEach((element, i) => {
      ...
      Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_10__["render"])(element, new _view_films_list_title_js__WEBPACK_IMPORTED_MODULE_4__["default"](EXTRA_FILMS_LIST_TITLES[i]), _utils_render_js__WEBPACK_IMPORTED_MODULE_10__["RenderPosition"].BEFOREEND);

      const elementFilmContainer = new _view_site_film_container_js__WEBPACK_IMPORTED_MODULE_5__["default"]();

      this._filmContainers.push(elementFilmContainer);

      Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_10__["render"])(element, elementFilmContainer, _utils_render_js__WEBPACK_IMPORTED_MODULE_10__["RenderPosition"].BEFOREEND);
  ...
  _renderFilmContainers() {
    ...
    this._filmsContainer = new _view_site_film_container_js__WEBPACK_IMPORTED_MODULE_5__["default"]();

    this._filmContainers.push(this._filmsContainer);

    Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_10__["render"])(this._siteDefaultFilmsList, this._filmsContainer, _utils_render_js__WEBPACK_IMPORTED_MODULE_10__["RenderPosition"].BEFOREEND);
  ...
  _clearMovieList({resetSortType = false, resetRenderedFilms = false, isPopupOppened = false} = {}) {
    ...
    Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_10__["remove"])(this._showMoreButton);
    Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_10__["remove"])(this._loadingComponent);
    Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_10__["remove"])(this._siteNoData);
  ...
  _renderSiteSort() {
    ...
    this._sortComponent = new _view_site_sort_js__WEBPACK_IMPORTED_MODULE_1__["default"](this._currentSortType);
    this._sortComponent.setSortTypeChangeHandler(this._handleSortTypeChange);

    Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_10__["render"])(this._filmContainer, this._sortComponent, _utils_render_js__WEBPACK_IMPORTED_MODULE_10__["RenderPosition"].AFTERBEGIN);
  }
  ...
  _renderMovies() {
    ...
    if (this._filterModel.getFiltrationType() === _const_js__WEBPACK_IMPORTED_MODULE_12__["FilterType"].STATS) {
      return;
    }
    ...
    this._extraFilmsListSortsTypes = [_utils_films_js__WEBPACK_IMPORTED_MODULE_11__["sortFilmsByRating"], _utils_films_js__WEBPACK_IMPORTED_MODULE_11__["sortFilmsByComments"]];
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return UserProfilePresenter; });
...
class UserProfilePresenter {
  ...
  init() {
    ...
    this._userProfileComponent = new _view_user_profile_js__WEBPACK_IMPORTED_MODULE_0__["default"](quantityOfWatched);

    if (prevUserProfileComponent === null) {
      Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_1__["render"])(this._profileContainer, this._userProfileComponent, _utils_render_js__WEBPACK_IMPORTED_MODULE_1__["RenderPosition"].BEFOREEND);
      return;
    }

    Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_1__["replace"])(this._userProfileComponent, prevUserProfileComponent);
    Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_1__["remove"])(prevUserProfileComponent);
  }
...
/*!*****************************!*\
  !*** ./src/utils/common.js ***!
  \*****************************/
/*! exports provided: getRandomInteger, getUserRank */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/*!****************************!*\
  !*** ./src/utils/films.js ***!
  \****************************/
/*! exports provided: formatDateYear, formatDateReleaseDate, formatDateComment, sortFilmsByDate, sortFilmsByRating, sortFilmsByComments, getTimeFromMins, getHoursFromMins, getRemainMins */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "formatDateYear", function() { return formatDateYear; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "formatDateReleaseDate", function() { return formatDateReleaseDate; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "formatDateComment", function() { return formatDateComment; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "sortFilmsByDate", function() { return sortFilmsByDate; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "sortFilmsByRating", function() { return sortFilmsByRating; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "sortFilmsByComments", function() { return sortFilmsByComments; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "getTimeFromMins", function() { return getTimeFromMins; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "getHoursFromMins", function() { return getHoursFromMins; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "getRemainMins", function() { return getRemainMins; });
...
const formatDateReleaseDate = (date) => {
...
const formatDateComment = (date) => {
  ...
  return moment__WEBPACK_IMPORTED_MODULE_0___default()(date).calendar(null, {
    sameDay: `[Today]`,
    lastDay: `[Yesterday]`,
    sameElse: `L HH:mm:ss`
  });
...
const filter = {
  ...
  [_const__WEBPACK_IMPORTED_MODULE_0__["FilterType"].WATCHLIST]: (films) => films.filter((film) => film.isInWatchlist),
  [_const__WEBPACK_IMPORTED_MODULE_0__["FilterType"].HISTORY]: (films) => films.filter((film) => film.isWatched),
  [_const__WEBPACK_IMPORTED_MODULE_0__["FilterType"].FAVORITES]: (films) => films.filter((film)=> film.isFavorite),
};
...
/*!*********************************!*\
  !*** ./src/utils/statistics.js ***!
  \*********************************/
/*! exports provided: getGenresFrequencies, isWasWatchedToday, isWasWatchedLastWeek, isWasWatchedLastMounth, isWasWatchedLastYear */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "getGenresFrequencies", function() { return getGenresFrequencies; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "isWasWatchedToday", function() { return isWasWatchedToday; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "isWasWatchedLastWeek", function() { return isWasWatchedLastWeek; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "isWasWatchedLastMounth", function() { return isWasWatchedLastMounth; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "isWasWatchedLastYear", function() { return isWasWatchedLastYear; });
/* harmony import */ var moment__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! moment */ "./node_modules/moment/moment.js");
/* harmony import */ var moment__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(moment__WEBPACK_IMPORTED_MODULE_0__);


const getGenresFrequencies = (films) => {
  const mapOfGenres = {};
...
const isWasWatchedToday = (date) => {
  if (date === null) {
    return false;
  }

  return moment__WEBPACK_IMPORTED_MODULE_0___default()(date).isSame(moment__WEBPACK_IMPORTED_MODULE_0___default()(), `d`);
};

const isWasWatchedLastWeek = (date) => {
  const todayDate = moment__WEBPACK_IMPORTED_MODULE_0___default()(new Date());
  const lastWeekDate = moment__WEBPACK_IMPORTED_MODULE_0___default()(todayDate).subtract(1, `w`);

  return moment__WEBPACK_IMPORTED_MODULE_0___default()(date).isBetween(lastWeekDate, todayDate);
};

const isWasWatchedLastMounth = (date) => {
  const todayDate = moment__WEBPACK_IMPORTED_MODULE_0___default()(new Date());
  const lastMounthDate = moment__WEBPACK_IMPORTED_MODULE_0___default()(todayDate).subtract(1, `M`);

  return moment__WEBPACK_IMPORTED_MODULE_0___default()(date).isBetween(lastMounthDate, todayDate);
};

const isWasWatchedLastYear = (date) => {
  const todayDate = moment__WEBPACK_IMPORTED_MODULE_0___default()(new Date());
  const lastYearDate = moment__WEBPACK_IMPORTED_MODULE_0___default()(todayDate).subtract(1, `y`);

  return moment__WEBPACK_IMPORTED_MODULE_0___default()(date).isBetween(lastYearDate, todayDate);
};
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return DetailsComments; });
/* harmony import */ var _abstract_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./abstract.js */ "./src/view/abstract.js");
/* harmony import */ var _utils_films_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../utils/films.js */ "./src/utils/films.js");
...
const createComments = (comments, deletingComment, isDisabled, isDeleting) => {
  ...
  for (let i = 0; i < comments.length; i++) {
    ...
    `<li class="film-details__comment">
      ...
      <img src="${_const_js__WEBPACK_IMPORTED_MODULE_2__["emojiMap"][comments[i].emoji]}" width="55" height="55" alt="emoji-${comments[i].emoji}">
      </span>
      <div>
        <p class="film-details__comment-text">${he__WEBPACK_IMPORTED_MODULE_3___default.a.encode(comments[i].text)}</p>
        <p class="film-details__comment-info">
          <span class="film-details__comment-author">${comments[i].name}</span>
          <span class="film-details__comment-day">${Object(_utils_films_js__WEBPACK_IMPORTED_MODULE_1__["formatDateComment"])(comments[i].date)}</span>
...
const createUserEmojiTemplate = (userEmoji) => {
  return userEmoji === `` ? `` : `<img src="${_const_js__WEBPACK_IMPORTED_MODULE_2__["emojiMap"][userEmoji]}" width="55" height="55" alt="emoji-smile">`;
};
...
class DetailsComments extends _abstract_js__WEBPACK_IMPORTED_MODULE_0__["default"] {
...
/***/ "./src/view/details-description.js":
/*!*****************************************!*\
  !*** ./src/view/details-description.js ***!
  \*****************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return DetailsDescription; });
/* harmony import */ var _abstract_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./abstract.js */ "./src/view/abstract.js");
/* harmony import */ var _utils_films_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../utils/films.js */ "./src/utils/films.js");
  ...
  <div class="film-details__info">
    ...
    <table class="film-details__table">
      ...
      <tr class="film-details__row">
        ...
        <td class="film-details__cell">${Object(_utils_films_js__WEBPACK_IMPORTED_MODULE_1__["formatDateReleaseDate"])(releaseDate)}</td>
      </tr>
      <tr class="film-details__row">
        <td class="film-details__term">Runtime</td>
        <td class="film-details__cell">${Object(_utils_films_js__WEBPACK_IMPORTED_MODULE_1__["getTimeFromMins"])(filmDuration)}</td>
      </tr>
      <tr class="film-details__row">
...
class DetailsDescription extends _abstract_js__WEBPACK_IMPORTED_MODULE_0__["default"] {
  constructor(data) {
    super();
    this._data = data;
  }
...
/* harmony import */ var _details_description_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./details-description.js */ "./src/view/details-description.js");
/* harmony import */ var _details_comments_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./details-comments.js */ "./src/view/details-comments.js");
...
const createSiteFilmDetailsPopup = (data, deletingComment) => {
  ...
  <form class="film-details__inner" action="" method="get">
    <div class="form-details__top-container">
          ${new _details_description_js__WEBPACK_IMPORTED_MODULE_0__["default"](data).getTemplate()}
    </div>
    <div class="form-details__bottom-container">
          ${new _details_comments_js__WEBPACK_IMPORTED_MODULE_1__["default"](comments, userEmoji, deletingComment, isDisabled, isDeleting, isSaving).getTemplate()}
    </div>
  </form>
</section>`
  );
...
class FilmPopup extends _smart_js__WEBPACK_IMPORTED_MODULE_2__["default"] {
  constructor(data) {
    super();
  ...
  getTemplate() {
    return createSiteFilmDetailsPopup(this._data, this._deletingComment);
  }
  ...
  _createComment(emoji, text) {
    return {
      ...
      date: new Date(),
      emoji,
      img: _const_js__WEBPACK_IMPORTED_MODULE_3__["emojiMap"][emoji],
    };
  }
  ...
  _addCommentKeyDown(evt) {
    if ((evt.ctrlKey && evt.key === _const_js__WEBPACK_IMPORTED_MODULE_3__["ENTER_CODE"]) && this._userEmoji && this._userText) {
...
const createSiteFilmCard = (film) => {
  ...
  return (
    ...
    <p class="film-card__info">
      <span class="film-card__year">${Object(_utils_films_js__WEBPACK_IMPORTED_MODULE_1__["formatDateYear"])(releaseDate)}</span>
      <span class="film-card__duration">${Object(_utils_films_js__WEBPACK_IMPORTED_MODULE_1__["getTimeFromMins"])(filmDuration)}</span>
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return FilmsListTitle; });
/* harmony import */ var _abstract_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./abstract.js */ "./src/view/abstract.js");
...
class FilmsListTitle extends _abstract_js__WEBPACK_IMPORTED_MODULE_0__["default"] {
  constructor(name) {
    super();
    this._name = name;
  }
...
class FooterStatistic extends _abstract_js__WEBPACK_IMPORTED_MODULE_0__["default"] {
...
/***/ "./src/view/site-film-container.js":
/*!*****************************************!*\
  !*** ./src/view/site-film-container.js ***!
  \*****************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return SiteFilmsList; });
/* harmony import */ var _utils_render_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../utils/render.js */ "./src/utils/render.js");
...
class SiteFilmsList extends _abstract_js__WEBPACK_IMPORTED_MODULE_1__["default"] {
  ...
  destroy() {
    Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_0__["remove"])(this);
  }
}
...
/***/ "./src/view/site-main-content-containers.js":
/*!**************************************************!*\
  !*** ./src/view/site-main-content-containers.js ***!
  \**************************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return SiteMainContentContainers; });
/* harmony import */ var _abstract_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./abstract.js */ "./src/view/abstract.js");
...
class SiteMainContentContainers extends _abstract_js__WEBPACK_IMPORTED_MODULE_0__["default"] {
  getTemplate() {
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return SiteNav; });
/* harmony import */ var _abstract_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./abstract.js */ "./src/view/abstract.js");
/* harmony import */ var _const_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../const.js */ "./src/const.js");
...
const createSiteNav = (filters, currentMenuItem, isDisable) => {
  ...
  return (
    ...
    <div class="main-navigation__items">
      <a href="#all" class="main-navigation__item ${currentMenuItem === _const_js__WEBPACK_IMPORTED_MODULE_1__["FilterType"].ALL ? ACTIVECLASS : ``}" data-item="${_const_js__WEBPACK_IMPORTED_MODULE_1__["MenuItem"].FILTER}" ${isDisable ? `disabled` : ``}>All movies</a>
      <a href="#watchlist" class="main-navigation__item ${currentMenuItem === _const_js__WEBPACK_IMPORTED_MODULE_1__["FilterType"].WATCHLIST ? ACTIVECLASS : ``}" data-item="${_const_js__WEBPACK_IMPORTED_MODULE_1__["MenuItem"].FILTER}" ${isDisable ? `disabled` : ``}>Watchlist <span class="main-navigation__item-count">${watchlist}</span></a>
      <a href="#history" class="main-navigation__item ${currentMenuItem === _const_js__WEBPACK_IMPORTED_MODULE_1__["FilterType"].HISTORY ? ACTIVECLASS : ``}" data-item="${_const_js__WEBPACK_IMPORTED_MODULE_1__["MenuItem"].FILTER}" ${isDisable ? `disabled` : ``}>History <span class="main-navigation__item-count">${history}</span></a>
      <a href="#favorites" class="main-navigation__item ${currentMenuItem === _const_js__WEBPACK_IMPORTED_MODULE_1__["FilterType"].FAVORITES ? ACTIVECLASS : ``}" data-item="${_const_js__WEBPACK_IMPORTED_MODULE_1__["MenuItem"].FILTER}" ${isDisable ? `disabled` : ``}>Favorites <span class="main-navigation__item-count">${favorite}</span></a>
    </div>
    <a href="#stats" class="main-navigation__additional ${currentMenuItem === _const_js__WEBPACK_IMPORTED_MODULE_1__["FilterType"].STATS ? ACTIVECLASS : ``}" data-item="${_const_js__WEBPACK_IMPORTED_MODULE_1__["MenuItem"].STATISTICS}" ${isDisable ? `disabled` : ``}>Stats</a>
  </nav>`
  );
};

class SiteNav extends _abstract_js__WEBPACK_IMPORTED_MODULE_0__["default"] {
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return SiteNoData; });
/* harmony import */ var _abstract_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./abstract.js */ "./src/view/abstract.js");
...
class SiteNoData extends _abstract_js__WEBPACK_IMPORTED_MODULE_0__["default"] {
  getTemplate() {
...
const createSiteSort = (currentSortType) => {
  return (
    `<ul class="sort">
...
class SiteSort extends _abstract_js__WEBPACK_IMPORTED_MODULE_0__["default"] {
  ...
  getTemplate() {
    return createSiteSort(this._currentSortType);
  }
...
/* harmony import */ var _utils_render_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../utils/render.js */ "./src/utils/render.js");
/* harmony import */ var _utils_films_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../utils/films.js */ "./src/utils/films.js");
...
/* harmony import */ var _utils_statistics_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../utils/statistics.js */ "./src/utils/statistics.js");
...
const getStatisticCaseFilms = {
  ...
  [`statistic-today`]: (films) => [...films].filter((film) => Object(_utils_statistics_js__WEBPACK_IMPORTED_MODULE_6__["isWasWatchedToday"])(film.watchingDate)),
  [`statistic-week`]: (films) => [...films].filter((film) => Object(_utils_statistics_js__WEBPACK_IMPORTED_MODULE_6__["isWasWatchedLastWeek"])(film.watchingDate)),
  [`statistic-month`]: (films) => [...films].filter((film) => Object(_utils_statistics_js__WEBPACK_IMPORTED_MODULE_6__["isWasWatchedLastMounth"])(film.watchingDate)),
  [`statistic-year`]: (films) => [...films].filter((film) => Object(_utils_statistics_js__WEBPACK_IMPORTED_MODULE_6__["isWasWatchedLastYear"])(film.watchingDate)),
};

const renderCharts = (films, statisticCtx) => {
  const BAR_HEIGHT = 50;

  statisticCtx.height = BAR_HEIGHT * Object.keys(Object(_utils_statistics_js__WEBPACK_IMPORTED_MODULE_6__["getGenresFrequencies"])(films)).length;

  const myChart = new chart_js__WEBPACK_IMPORTED_MODULE_4___default.a(statisticCtx, {
    plugins: [chartjs_plugin_datalabels__WEBPACK_IMPORTED_MODULE_5___default.a],
    type: `horizontalBar`,
    data: {
      labels: Object.keys(Object(_utils_statistics_js__WEBPACK_IMPORTED_MODULE_6__["getGenresFrequencies"])(films)),
      datasets: [{
        data: Object.values(Object(_utils_statistics_js__WEBPACK_IMPORTED_MODULE_6__["getGenresFrequencies"])(films)),
...
const getTheMostFrequentGenre = (films) => {
  ...
  const genresObject = Object(_utils_statistics_js__WEBPACK_IMPORTED_MODULE_6__["getGenresFrequencies"])(films);
  ...
  return (
    ...
    <ul class="statistic__text-list">
      ...
      <li class="statistic__text-item">
        ...
        <p class="statistic__item-text">${watchedFilms.length ? `${Object(_utils_films_js__WEBPACK_IMPORTED_MODULE_2__["getHoursFromMins"])(totalTimeWatched)}<span class="statistic__item-description">h</span> ${Object(_utils_films_js__WEBPACK_IMPORTED_MODULE_2__["getRemainMins"])(totalTimeWatched)} <span class="statistic__item-description">m</span>` : ``}</p>
      </li>
      <li class="statistic__text-item">
...
class Statistics extends _smart_js__WEBPACK_IMPORTED_MODULE_0__["default"] {
  constructor(films, statisticContainer) {
    super();

    this._statisticContainer = statisticContainer;
    this._films = [...films].filter((film)=> film.isWatched);
    this._userRank = Object(_utils_common_js__WEBPACK_IMPORTED_MODULE_3__["getUserRank"])(this._films.length);
    this._setChart();
  }
  ...
  destroy() {
    Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_1__["remove"])(this);
  }
  ...
  _setChart(dateCase = statisticsCasesMap.ALLTIME) {
    ...
    Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_1__["render"])(this._statisticContainer, this.getElement(), _utils_render_js__WEBPACK_IMPORTED_MODULE_1__["RenderPosition"].BEFOREEND);
    this.restoreHandlers();
...
class UserProfile extends _abstract_js__WEBPACK_IMPORTED_MODULE_0__["default"] {
  ...
  constructor(quantityOfWatched) {
    super();
    this._rank = Object(_utils_common_js__WEBPACK_IMPORTED_MODULE_1__["getUserRank"])(quantityOfWatched);
  }
